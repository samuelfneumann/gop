...
// TestF64ClampPassGradient tests if the clamp operation works in the
// forward pass on a float64 tensor and if the gradient is passed
// through the operation when requested to do so.
func TestF64ClampPassGradient(t *testing.T) {
